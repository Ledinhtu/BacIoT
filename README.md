...
- Cấu hình địa chỉ URI server : `COAP_OBSERVE_URI` cho observe, `COAP_POST_URI` cho post method trong file `coap_device\coap_client\main\coap_client_example_main.c`
